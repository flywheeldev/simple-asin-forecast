    ...
    if uploaded_file is not None:
        ...
        if df is not None:
            ...
            if st.session_state.forecast_results is None:
                ...
                loading_messages = [
                    "Overheard in the kitchen before anyone was in the office (or so they thought): 'If this test tanks, we’re blaming seasonality, right?'",
                    "He used the phrase 'clickshare enlightenment.' We're worried.",
                    "Amazon said we were exclusive. Then I saw them with 6 other brands on the same shelf.",
                    "Overheard in performance review season: 'How do I measure emotional ROAS?'",
                    "Overheard at the water cooler: 'It’s not broken—it’s A/B testing itself.'",
                    "Walmart’s pricing strategy is like a suspense movie. Just when you think it can’t go lower… it rolls back again.",
                    "Overheard below the fold, near the insights pod: 'She’s still trying to prove that display campaign moved the needle. It’s been three decks.'",
                    "Why did the CPC break up with the CTR? They weren't getting enough impressions.",
                    "Overheard near the snack drawer: 'She says “omnichannel” like it’s a love language.'",
                    "Our creative testing results were inconclusive, but emotionally devastating.",
                    "The campaign's learning phase is starting to feel personal.",
                    "Why did the shopper bounce? Honestly, I would too.",
                    "Overheard outside the client room: 'Act like we meant to do that with the targeting.'",
                    "The post-click experience needs therapy.",
                    "Overheard in the fishbowl after the QBR: 'They nodded through the whole thing. Then asked what “DSP” stood for.'",
                    "Why did the ad group bring a suitcase? It heard we were going cross-channel.",
                    "We didn’t go off-brief, we went on a creative journey.",
                    "Our audience segments are basically astrology with better dashboards.",
                    "I clicked on my own ad just to feel something.",
                    "Overheard in the intern huddle: 'Just say it’s proprietary logic and smile.'",
                    "The ad isn’t underperforming, the customer is.",
                    "We built this strategy with science, luck, and 12 bookmarked Reddit threads.",
                    "We told the client it's 'intent-rich' traffic. It was mostly bots.",
                    ...
                    "This ROAS is being held together with retargeting and a dream.",
                    "Our ad copy tested so well we considered running it internally—for morale.",
                    "Let’s circle back—so we can land in the same place but more tired.",
                    "Sponsored Products are like reality stars. Flashy, visible, and nobody knows if they actually work.",
                    "Overheard in the stairwell between the media and analytics teams: 'If they ask where the baseline data went, just say it was suppressed for clarity.'",
                    "Overheard during onboarding: 'So... we do all this every week?'",
                    "Overheard in the hallway outside the exec suite: 'We told them it was intentional. It wasn’t.'",
                    "Our A/B test turned into a C- result.",
                    "I asked Alexa how to boost my ROAS. She played 'Fix You' by Coldplay.",
                    "We didn’t miss the KPI... we innovated a new benchmark.",
                    "I don’t always fall in love, but when I do, it’s with a cart that hasn’t been abandoned.",
                    "We called it a Smart Campaign™. It called us back dumb.",
                    "Overheard near the whiteboard in strategy: 'Let’s just say the forecast is mostly vibes at this point.'",
                    "That wasn't an ad plan. That was a cry for help in PowerPoint form.",
                    "Someone just asked what PDP stands for. It's their third week.",
                    "Overheard on Teams: 'No worries, we’ll just say it was a learning moment.'",
                    "This campaign is like my houseplants—too many variables, not enough light.",
                    "You know you work in e-comm when you say 'PDP' more than you say 'I love you.'",
                    "Retail media math: 2 + 2 = 'It depends on attribution.'",
                    "Every time someone says 'upper funnel,' a KPI dies inside.",
                    "Overheard at the agency holiday party: 'This year I’m thankful for default bid multipliers.'",
                    "Overheard by the bathrooms after a team sync: 'She asked if anyone had actually read the media brief. The silence was louder than the Dyson.'",
                    "The attribution model needs a support group.",
                    "We’re just trying to stay above the fold—and above water.",
                    "This creative tested so well internally we decided not to show it to real people.",
                    "Overheard while passing the printer: 'Did you optimize the headline or just rearrange buzzwords?'",
                    "The post-click journey needs therapy.",
                    "Every product page is just a trust fall in HTML.",
                    "Our Display ads are like office coffee—technically there, but nobody remembers engaging with them.",
                    "Overheard in the fishbowl conference room: 'Let’s just say the vendor didn’t appreciate our “constructive” feedback on the PDP layout.'",
                    "That media plan had more pivots than a jazz solo.",
                    "She said it was full-funnel. It was just a leaky bucket.",
                    "My conversion rate’s like my gym membership—low effort, high expectations.",
                    "We said 'data-driven' so many times, I think Excel started judging us.",
                    "Overheard in the war room: 'If this fails, we pivot to vibes-based reporting.'",
                    "He said he wanted full funnel, but flinched at the word 'awareness.'",
                    "She’s the kind of planner who adds 'Q4-ready' to everything... in March.",
                    "That PDP image carousel is the stuff of digital regret.",
                    "Why does the campaign brief read like a ransom note?",
                    "We set up the campaign for success, and then success ran out of budget.",
                    "Overheard in the hallway near ATF (Above the Fold): 'I don’t think he realizes the campaign’s still live—and the daily cap hasn’t been touched.'",
                    "Programmatic isn’t confusing. It’s just 4,000 acronyms pretending to know you better than your spouse.",
                    "Overheard in the lobby before the client arrived: 'They approved the creative. I don’t think they actually opened the file.'",
                    "We launched the campaign and immediately blamed the algorithm. A tradition unlike any other.",
                    "Overheard in the parking garage during a phone call: 'I don’t care what their branded search looks like—pull the damn spend.'",
                    "That strategy deck had animations. We knew we were in trouble.",
                    "Overheard in the fishbowl after the QBR: 'They nodded through the whole thing. Then asked what “DSP” stood for.'",
                    "We built this strategy with science, luck, and 12 bookmarked Reddit threads.",
                    "Overheard in the kitchen at the Baltimore office: 'She told the client their ROAS expectations were unrealistic… and then hit send anyway.'",
                    "Dating an Amazon algorithm is wild. One day you’re the #1 choice. The next, 'customers also bought literally anything else.'",
                    "Our CTR went up after we stopped trying. Not sure what to do with that information.",
                    "Overheard near the AV closet during a fire drill: 'I didn’t know Walmart had a DSP either. But I’m presenting on it Friday.'",
                    "Why did the pixel cry? It lost track of everyone it ever loved.",
                    "We didn’t go off-brief. We went on a creative journey.",
                    "Overheard in the elevator heading to 3rd floor: 'He brought up incrementality again. Someone has to stop him.'",
                    ...
                    "Overheard near the espresso machine on launch day: 'The bid strategy changed overnight. Nobody told the client. Yet.'",
                    "Their PDP had 17 bullet points. None of them explained what the product does.",
                    "We didn’t miss the KPI. We invented a new benchmark.",
                    "I asked my media buyer to optimize the campaign. She lit a candle and whispered 'ROAS' three times.",
                    "Someone said 'always-on' like it’s a good thing.",
                    "Why did the client love the deck? We changed the font.",
                    "This ROAS is being held together with retargeting and a dream.",
                    "Overheard on Zoom: 'We have data to support both decisions… unfortunately.'",
                    "We’re just trying to stay above the fold—and above water.",
                    "Our A/B test turned into a C- result.",
                    "Let’s circle back—so we can land in the same place but more tired.",
                    "We didn’t miss the KPI… we innovated a new benchmark.",
                    "Overheard during budget review: 'We can either eat lunch or fund upper funnel.'",
                    "That media plan had more pivots than a jazz solo.",
                    "Sometimes I stare at the ad performance chart like it’s going to tell me who I really am.",
                    "You know you work in e-comm when you say 'PDP' more than you say 'I love you.'",
                    "My PDP ghosted me. Turns out it just wasn’t converting anymore.",
                    "Retail media math: 2 + 2 = 'It depends on attribution.'"
